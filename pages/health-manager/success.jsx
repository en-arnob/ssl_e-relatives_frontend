...
const Success = () => {
  ...
  useEffect(() => {
    const timer = setTimeout(() => {
      Router.push("https://e-relatives.com");
    }, 5000);
                ...
                <div className="col-md-8 border-right">
                  <div className="p-3 py-5">
                    <div className="d-flex justify-content-between align-items-center mb-2">
                      <h4 className="text-right text-success fw-normal">
                        Your Health Manager Subscription payment is successfully
                        completed!
                      </h4>
                    </div>
                    <div className=" align-items-center ">
                      <h5 className="text-right fw-normal ">
                        ...
                        <span className="text-primary">E-Relatives</span> as
                        your Health-Manager.
                      </h5>
